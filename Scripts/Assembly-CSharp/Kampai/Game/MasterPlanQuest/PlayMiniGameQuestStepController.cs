...
{
	public class PlayMiniGameQuestStepController : BuildingTaskQuestStepController
	{
		...
		public PlayMiniGameQuestStepController(Quest quest, int stepIndex, IDefinitionService definitionService, IPlayerService playerService, ICrossContextCapable gameContext, IKampaiLogger logger)
